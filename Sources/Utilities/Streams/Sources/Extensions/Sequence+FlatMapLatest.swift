...
public extension AsyncSequence {
    func flatMapLatest<ResultSequence: AsyncSequence>(_ transformation: @Sendable @escaping (Element) async -> ResultSequence) -> AsyncThrowingStream<ResultSequence.Element, any Error>
